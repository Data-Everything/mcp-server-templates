...
class TestZendeskMCPIntegration:
    ...
    def integration_server(self, mock_config_data):
        ...
        with patch('server.ZendeskServerConfig') as mock_config_class:
            ...
            mock_config_instance.get_zendesk_url.return_value = "https://testcompany.zendesk.com"
    ...
    async def test_ticket_workflow_integration(self, integration_server):
        ...
        with patch.object(server, '_make_request') as mock_request:
            ...
            # Test get ticket
            get_result = await server.get_ticket(
                ticket_id=123,
    ...
    async def test_knowledge_base_integration(self, integration_server):
        ...
        with patch.object(server, '_make_request') as mock_request:
            ...
            search_result = await server.search_articles(
                query="API",
                locale="en-us"
            )
            ...
            article_result = await server.get_article(
                article_id=789,
                locale="en-us"
            )
        ...
        with patch.object(server, '_make_request') as mock_request:
            mock_request.return_value = {
                "results": [
                    ...
                    {"id": 125, "status": "closed", "priority": "low", "type": "question"},
                    {"id": 126, "status": "pending", "priority": "normal", "type": "task"}
                ],
                "count": 4
            }

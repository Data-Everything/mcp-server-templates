...
class TestDockerDiscoveryIntegration:
    ...
    def test_template_discovery_uses_docker_for_dynamic_templates(self, mock_docker_discovery):
    ...
    @patch('mcp_template.tools.mcp_client_probe.MCPClientProbe.discover_tools_from_docker_sync')
    def test_mcp_client_handles_github_server_args(self, mock_discover):
        ...
        mock_discover.return_value = {
            "tools": [{"name": "github_tool", "description": "Test", "category": "mcp", "parameters": {}}],
    ...
    def test_discovery_priority_order(self, mock_docker_discovery):
        ...
        mock_docker_discovery.side_effect = [
            ...
            {       # Second call succeeds
                "tools": [{"name": "docker_tool", "description": "Docker tool", "category": "mcp", "parameters": {}}],
                "discovery_method": "docker_mcp_stdio"
            }
        ]
    ...
    def test_cli_passes_config_values_to_discovery(self, mock_docker_discovery):
        ...
        mock_docker_discovery.return_value = {
            "tools": [{"name": "cli_tool", "description": "CLI tool", "category": "mcp", "parameters": {}}],
            "discovery_method": "docker_mcp_stdio"
        }
        ...
        with patch.object(self.cli.tool_discovery, 'discover_tools') as mock_discover_tools:
...
class TestDockerProbeIntegration:
    ...
    def test_docker_probe_uses_mcp_client(self, mock_mcp_discover):
        ...
        mock_mcp_discover.return_value = {
            "tools": [{"name": "mcp_tool", "description": "MCP tool", "category": "mcp", "parameters": {}}],
            "discovery_method": "mcp_client"
        }

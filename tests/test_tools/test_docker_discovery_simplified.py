...
class TestDockerDiscoveryBasic:
    ...
    def test_fallback_to_capabilities_when_docker_fails(self):
        ...
        template_config = {
            ...
            "tool_discovery": "dynamic",
            "capabilities": [
                {"name": "fallback_tool", "description": "A fallback capability"}
            ],
        }
...
class TestEndToEndBehavior:
    ...
    def test_github_template_scenario(self):
        ...
        github_template_config = {
            ...
            "docker_tag": "0.9.1",
            "capabilities": [
                {"name": "example", "description": "A simple example tool"}
            ],
            "config_schema": {
                "properties": {
        ...
        with patch(
            "mcp_template.tools.docker_probe.DockerProbe.discover_tools_from_image"
        ) as mock_docker:
            ...
            assert (
                call_args[1]["env_vars"]["GITHUB_PERSONAL_ACCESS_TOKEN"] == "test_token"
            )

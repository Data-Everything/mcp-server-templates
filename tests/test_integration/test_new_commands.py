...
class TestCommandIntegration:
    ...
    def test_cleanup_integration(self, deployment_manager):
        ...
        with patch.object(deployment_manager.backend, 'cleanup_stopped_containers') as mock_cleanup:
    ...
    def test_connect_integration(self, deployment_manager):
        ...
        with patch.object(deployment_manager.backend, 'connect_to_deployment') as mock_connect:
    ...
    def test_dangling_images_cleanup_integration(self, deployment_manager):
        ...
        with patch.object(deployment_manager.backend, 'cleanup_dangling_images') as mock_cleanup:
            mock_cleanup.return_value = {
                "success": True,
...
class TestEndToEndScenarios:
    ...
    def test_full_cleanup_scenario(self):
        ...
        with patch('subprocess.run') as mock_run, \
             patch('mcp_template.backends.docker.DockerDeploymentService._ensure_docker_available'):

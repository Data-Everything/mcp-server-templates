...
class TestAllTemplates:
    ...
    def test_all_templates_have_required_structure(self, template_list):
        ...
        for template_name in template_list:
            try:
                ...
                pytest.fail(f"Template {template_name} structure validation failed: {e}")
    ...
    def test_all_templates_build_successfully(self, template_list):
        ...
        for template_name in template_list:
            ...
            assert result["structure_valid"], f"{template_name}: Structure validation failed"
            ...
            if template_name in ["file-server"]:  # Production-ready templates
                ...
                assert result["container_starts"], f"{template_name}: Container failed to start"
                assert result["health_check_passes"], f"{template_name}: Health check failed"

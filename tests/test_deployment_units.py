...
from mcp_deploy import TemplateDiscovery, MCPDeployer, DeploymentManager, DockerDeploymentService
...
class TestTemplateDiscovery:
    ...
    def test_generate_template_config(self):
        ...
        config = discovery._generate_template_config(template_data, Path("test-template"))

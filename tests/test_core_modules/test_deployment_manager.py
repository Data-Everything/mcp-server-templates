...
class TestDeploymentManager:
    ...
    def test_stop_deployment_success(self):
        ...
        with patch.object(
            self.deployment_manager.backend,
            "get_deployment_status",
            return_value=mock_deployment_info,
        ):
            with patch.object(
                self.deployment_manager.backend, "delete_deployment", return_value=True
            ):
    ...
    def test_stop_deployment_with_force(self):
        ...
        with patch.object(
            ...
            with patch.object(
                ...
                result = self.deployment_manager.stop_deployment(
                    deployment_id, force=True
                )
    ...
    def test_get_deployment_logs_success(self):
        ...
        with patch.object(
            self.deployment_manager.backend, "get_deployment_status"
        ) as mock_status:
    ...
    def test_stream_deployment_logs(self):
        ...
        with patch.object(
            ...
            with patch.object(
                self.deployment_manager,
                "_stream_logs_from_backend",
                return_value=mock_log_generator(),
            ):
                logs = list(
                    self.deployment_manager.stream_deployment_logs(deployment_id)
                )
...
class TestDeploymentManager:
    ...
    def test_stop_deployment_success(self):
        ...
        with patch.object(
            ...
            with patch.object(
                self.deployment_manager.backend, "stop_deployment", return_value=True
            ):
    ...
    def test_stop_deployment_not_found(self):
        """Test stopping non-existent deployment."""
        with patch.object(
            self.deployment_manager.backend, "get_deployment_info", return_value=None
        ):
    ...
    def test_stop_deployment_with_force(self):
        ...
        with patch.object(
            ...
            with patch.object(
                self.deployment_manager.backend, "stop_deployment", return_value=False
            ):
                with patch.object(
                    self.deployment_manager.backend,
                    "force_stop_deployment",
                    return_value=True,
                ):
                    result = self.deployment_manager.stop_deployment(
                        "demo-123", force=True
    ...
    def test_stop_deployments_bulk(self):
        ...
        with patch.object(
            self.deployment_manager, "stop_deployment", side_effect=mock_stop_deployment
        ):
    ...
    def test_get_deployment_logs_success(self):
        """Test successful log retrieval."""
        mock_deployment_info = {"id": "demo-123", "template": "demo"}
    ...
    def test_find_deployment_for_logs(self):
        ...
        mock_deployments = [{"id": "demo-123", "template": "demo", "name": "my-demo"}]
        ...
        with patch.object(
            self.deployment_manager, "find_deployments_by_criteria", return_value=[]
        ):
            deployment_id = self.deployment_manager.find_deployment_for_logs(

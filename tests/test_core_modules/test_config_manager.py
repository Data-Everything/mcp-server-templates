...
class TestConfigManager:
    ...
    def test_process_overrides_nested(self):
        ...
        overrides = {
            "tools__0__custom_field": "modified",
            "server__port": "9090"
        }
    ...
    def test_validate_template_configuration(self):
        ...
        with patch.object(self.config_manager, 'load_configuration_for_template', return_value=mock_configs):
...
"""
    ...
    def test_full_config_merge_workflow(self):
        ...
        try:
            ...
            assert result["server"]["host"] == "localhost"  # Template value (env mapping not implemented)

...
class TestShellCommand:
    ...
    def test_shell_with_template_name_single_deployment(self, cli, mock_args):
        ...
        with patch.object(cli.deployment_manager, 'find_deployments_by_criteria', return_value=running_deployments), \
             patch.object(cli.deployment_manager, 'connect_to_deployment') as mock_connect, \
    ...
    def test_shell_with_custom_name(self, cli, mock_args):
        ...
        with patch.object(cli.deployment_manager, 'connect_to_deployment') as mock_connect, \
             patch.object(cli.formatter, 'print_info') as mock_info:
    ...
    def test_shell_connection_failure(self, cli, mock_args):
        ...
        with patch.object(cli.deployment_manager, 'connect_to_deployment', side_effect=Exception("Connection failed")), \
             patch.object(cli.formatter, 'print_error') as mock_error, \
             pytest.raises(SystemExit):

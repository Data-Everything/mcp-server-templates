#!/usr/bin/env python3
"""
Integration tests for database template.
...
class TestDatabaseIntegration:
    """Integration tests for database template deployment."""
    ...
    def test_template_deployment(self, deployer):
        ...
        if "database" not in deployer.templates:
            pytest.skip("database template not available")

        # Deploy template
        success = deployer.deploy("database")
        ...
        template_deployments = [d for d in deployments if d["template"] == "database"]
    ...
    def test_container_health(self):
        ...
        with build_and_run_template("database", config) as container:
    ...
    def test_configuration_mapping(self, deployer):
        ...
        template = deployer.templates["database"]
